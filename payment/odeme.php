...
<head>
    ...
    <title>rapixel.net Bakiye Yükleme</title>
    ...
    <div class="d-flex justify-content-center" style="padding-top: 100px;">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert">E-Posta adresiniz sitemize kayıt olduğunuz e-posta adresi olmalıdır!</div>
                    <form action="payment.php" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputFirstName">Ad:</label>
                                <input type="text" name="first_name" class="form-control" id="inputFirstName" placeholder="Kagan" required="reqiured">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputLastName">Soyad:</label>
                                <input type="text" name="last_name" class="form-control" id="inputLastName" placeholder="Cengiz" required="reqiured">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">E-Posta Adresi:</label>
                            <input type="email" name="email" class="form-control" id="inputEmail" placeholder="destek@rapixel.conet" required="reqiured">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" class="form-control" id="inputAmount" placeholder="100" required="reqiured">
                        </div>
                        <hr class="mb-4">
